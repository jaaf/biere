...
class EquipmentDialogWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.ui.mtCapacityEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,3}[\\.][0-9]{0,1}")))
        self.ui.ktCapacityEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,3}[\\.][0-9]{0,1}")))
        self.ui.fmCapacityEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,3}[\\.][0-9]{0,1}")))
        ...
        self.ui.mtRetentionEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,2}[\\.][0-9]{0,1}")))
        self.ui.ktRetentionEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,2}[\\.][0-9]{0,1}")))
        self.ui.fmRetentionEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,2}[\\.][0-9]{0,1}")))
        self.retention_validator.setNotation(QtGui.QDoubleValidator.Notation.StandardNotation) 
        ...
        self.ui.hopAbsorptionEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1}[\\.][0-9]{0,2}")))
        ...
        self.ui.looseCoeffEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-1]{1}[\\.][0-9]{0,2}")))
        ...
        self.ui.grainAbsorptionEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-1]{1}[\\.][0-9]{0,2}")))
        ...
        self.ui.kettleHeatSlopeEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,2}\\.[0-9]{1,2}")))
        ...
        self.ui.mtUnderGrainEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,3}\\.[0-9]{1,2}")))
        ...
        self.ui.mtThermalLossesEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-5]{1}\\.[0-9]{1,2}")))
        ...
        self.ui.mtHeatCapacityEquivEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1}\\.[0-9]{1,2}"))) 
        ...
        self.ui.mashThicknessEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-5]{1}\\.[0-9]{1,2}")))    
        ...
        self.ui.mashThicknessEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,2}\\.[0-9]{1,2}"))) 
        ...
        self.ui.ktDiameterEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,3}\\.[0-9]{1,2}"))) 
        self.ui.ktSteamExitEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-9]{1,3}\\.[0-9]{1,2}"))) 
        ...
        self.ui.ktEvaporationEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-5]{1}\\.[0-9]{1,2}"))) 
        ...
        self.ui.coolSlopeEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-5]{1}\\.[0-9]{1,2}")))  
        ...
        self.ui.coolFlowRateEdit.setValidator(QRegularExpressionValidator(QRegularExpression("[0-5]{1}\\.[0-9]{1,2}")))  
