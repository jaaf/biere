# Form implementation generated from reading ui file 'designer/brewwidget.ui'
#
...
class Ui_BrewWidget(object):
    def setupUi(self, BrewWidget):
        ...
        BrewWidget.resize(1474, 1253)
        font = QtGui.QFont()
        font.setFamily("Carlito")
        font.setPointSize(10)
        BrewWidget.setFont(font)
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(BrewWidget)
        ...
        self.verticalLayout_11.addWidget(self.headerGroupBox)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setSpacing(0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.general1GroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        ...
        self.general2GroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        ...
        self.label_13 = QtWidgets.QLabel(parent=self.general2GroupBox)
        self.label_13.setMinimumSize(QtCore.QSize(12, 0))
        self.label_13.setMaximumSize(QtCore.QSize(12, 16777215))
        self.label_13.setObjectName("label_13")
        self.horizontalLayout_66.addWidget(self.label_13)
        ...
        self.label_14 = QtWidgets.QLabel(parent=self.general2GroupBox)
        self.label_14.setMinimumSize(QtCore.QSize(12, 0))
        ...
        self.general3GroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        ...
        self.general4GroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        ...
        self.general5GroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        self.general5GroupBox.setStyleSheet("")
        self.general5GroupBox.setTitle("")
        self.general5GroupBox.setObjectName("general5GroupBox")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(self.general5GroupBox)
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.horizontalLayout_46 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_46.setObjectName("horizontalLayout_46")
        self.horizontalLayout_47 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_47.setObjectName("horizontalLayout_47")
        self.hotAfterSpargeWortVolumeLabel = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.hotAfterSpargeWortVolumeEdit = QtWidgets.QLineEdit(parent=self.general5GroupBox)
        ...
        self.hotAfterSpargeWortVolumeUnitLabel_7 = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.hotMaxWortVolumeLabel = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.hotMaxWortVolumeEdit = QtWidgets.QLineEdit(parent=self.general5GroupBox)
        ...
        self.hotAfterSpargeWortVolumeUnitLabel_8 = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.mashMaxVolumeLabel = QtWidgets.QLabel(parent=self.general5GroupBox)
        self.mashMaxVolumeLabel.setObjectName("mashMaxVolumeLabel")
        self.horizontalLayout_49.addWidget(self.mashMaxVolumeLabel)
        self.mashMaxVolumeEdit = QtWidgets.QLineEdit(parent=self.general5GroupBox)
        ...
        self.label_12 = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.afterSpargeGravityLabel = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.afterSpargeGravityEdit = QtWidgets.QLineEdit(parent=self.general5GroupBox)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.volumesHelpButton = QtWidgets.QPushButton(parent=self.general5GroupBox)
        ...
        self.mashEfficiencyLabel = QtWidgets.QLabel(parent=self.general5GroupBox)
        self.mashEfficiencyLabel.setObjectName("mashEfficiencyLabel")
        self.horizontalLayout_52.addWidget(self.mashEfficiencyLabel)
        self.mashEfficiencyEdit = QtWidgets.QLineEdit(parent=self.general5GroupBox)
        ...
        self.hotAfterSpargeWortVolumeUnitLabel_9 = QtWidgets.QLabel(parent=self.general5GroupBox)
        ...
        self.horizontalLayout_45.addWidget(self.general5GroupBox)
        self.general6GroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=BrewWidget)
        ...
        self.groupBox_fb.setGeometry(QtCore.QRect(0, 0, 1451, 891))
        self.groupBox_fb.setTitle("")
        self.groupBox_fb.setObjectName("groupBox_fb")
        self.tabWidget.addTab(self.tab, "")
        self.verticalLayout_11.addWidget(self.tabWidget)
        self.messageGroupBox = QtWidgets.QGroupBox(parent=BrewWidget)
        self.messageGroupBox.setTitle("")
        self.messageGroupBox.setObjectName("messageGroupBox")
        self.horizontalLayout_41 = QtWidgets.QHBoxLayout(self.messageGroupBox)
        self.horizontalLayout_41.setObjectName("horizontalLayout_41")
        self.messageLabel = QtWidgets.QLabel(parent=self.messageGroupBox)
        self.messageLabel.setObjectName("messageLabel")
        self.horizontalLayout_41.addWidget(self.messageLabel)
        self.closeMessageButton = QtWidgets.QPushButton(parent=self.messageGroupBox)
        self.closeMessageButton.setMaximumSize(QtCore.QSize(150, 16777215))
        self.closeMessageButton.setObjectName("closeMessageButton")
        self.horizontalLayout_41.addWidget(self.closeMessageButton)
        self.verticalLayout_11.addWidget(self.messageGroupBox)
    ...
    def retranslateUi(self, BrewWidget):
        ...
        self.label_13.setText(_translate("BrewWidget", "l"))
        self.coldSpargeWaterVolumeLabel.setText(_translate("BrewWidget", "Eau de rinçage (froid)"))
        self.label_14.setText(_translate("BrewWidget", "l"))
        ...
        self.messageLabel.setText(_translate("BrewWidget", "TextLabel"))
        self.closeMessageButton.setText(_translate("BrewWidget", "Cacher le message"))
